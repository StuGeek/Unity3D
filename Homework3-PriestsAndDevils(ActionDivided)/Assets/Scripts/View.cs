...
namespace PriestsAndDevils {
    ...
    public class BoatView {
        ...
        /* 为游戏对象添加移动控制器 */
        public ActionController AddActionScript() {
            ActionController actionScript = boat.AddComponent(typeof(ActionController)) as ActionController;
            return actionScript;
        }
    }
    ...
    public class RoleView {
        ...
        /* 为游戏对象添加移动控制器 */
        public ActionController AddActionScript() {
            ActionController actionScript = role.AddComponent(typeof(ActionController)) as ActionController;
            return actionScript;
        }
